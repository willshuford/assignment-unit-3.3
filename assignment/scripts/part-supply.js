...
// Create three new variables named 'positives', 'negatives', and 'zeroes' whose values are empty arrays.
let positives = [];
let negatives = [];
let zeroes = [];

// write a for loop that loops through the 'supplyChanges' array
